...
class SensorServiceImpl(val context: Context) : SensorService {
    ...
    override fun scanForSensor(): Flow<BluetoothDevice?> = callbackFlow {
    ...
    @RequiresPermission(Manifest.permission.BLUETOOTH_CONNECT)
    override fun getSensorDataFlow(address: String): Flow<SensorData?> = callbackFlow {
    ...
    override fun getBluetoothStateFlow(): Flow<Boolean> = callbackFlow {
